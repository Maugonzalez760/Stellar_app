...
export declare class Server {
    ...
    submitTransaction(transaction: Transaction, opts?: Server.SubmitTransactionOptions): Promise<Horizon.SubmitTransactionResponse>;
    ...
    checkMemoRequired(transaction: Transaction): Promise<void>;
}
